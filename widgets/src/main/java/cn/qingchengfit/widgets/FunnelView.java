...
public class FunnelView extends View implements ValueAnimator.AnimatorUpdateListener {
    ...
    private float mTotalHeight = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 240,
    ...
    private float maxWidth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 300,
            getResources().getDisplayMetrics());
    private float maxLineH = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 90,
            getResources().getDisplayMetrics());
    private float minLineH = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5,
            getResources().getDisplayMetrics());

    private float startOffsetX = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 30,
            getResources().getDisplayMetrics());
    private float startOffsetY = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20,
            getResources().getDisplayMetrics());
    ...
    private void drawText1(Canvas canvas) {
        ...
        canvas.drawText("初期沟通(10%)", maxWidth + textStartOffsetX, mLastY - mPath1Height / 2 + offY,
                mPaintText);
    }
    ...
    private void drawText2(Canvas canvas) {
        ...
        canvas.drawText("立项跟踪(10%)", maxWidth + textStartOffsetX, mLastY - mPath2Height / 2 + offY,
                mPaintText);
    }

    private void drawLine3(Canvas canvas) {
        canvas.drawLine(mPath3LineStartX + lineStartOffsetX, mPath3LineStartY, maxWidth,
                mPath3LineStartY, mPaintLine);
    }
    ...
    private void drawText3(Canvas canvas) {
        ...
        canvas.drawText("呈报方案(10%)", maxWidth + textStartOffsetX, mLastY - mPath3Height / 2 + offY,
                mPaintText);
    }

    private void drawLine4(Canvas canvas) {
        canvas.drawLine(mPath4LineStartX + lineStartOffsetX, mPath4LineStartY, maxWidth,
                mPath4LineStartY, mPaintLine);
    }
    ...
    private void drawText4(Canvas canvas) {
        ...
        canvas.drawText("商务谈判(10%)", maxWidth + textStartOffsetX, mLastY - mPath4Height / 2 + offY,
                mPaintText);
    }

    private void drawLine5(Canvas canvas) {
        canvas.drawLine(mPath5LineStartX + lineStartOffsetX, mPath5LineStartY, maxWidth,
                mPath5LineStartY, mPaintLine);
    }
    ...
    private void drawText5(Canvas canvas) {
        ...
        canvas.drawText("赢单(10%)", maxWidth + textStartOffsetX, mLastY - mPath5Height / 2 + offY,
                mPaintText);
    }
}
